...
public class BluetoothChatService extends Activity {
    ...
    private synchronized void setState(int state) {
        lw.appendLog(TAG, "setState() " + mState + " -> " + state);
        mState = state;
    ...
    public synchronized void connect(BluetoothDevice device, boolean secure) {
        lw.appendLog(TAG, "connect to: " + device);
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice
        ...
        lw.appendLog(TAG, "connected, Socket Type:" + socketType);
    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            lw.appendLog(TAG, "Socket Type: " + mSocketType +
            ...
            while (mState != STATE_CONNECTED) {
                try {
                    ...
                    lw.appendLog(TAG, "Socket Type: " + mSocketType + "accept() failed" + e);
                    break;
                }
                        ...
                        switch (mState) {
                            ...
                            case STATE_CONNECTED:
                                ...
                                try {
                                    ...
                                    lw.appendLog(TAG, "Could not close unwanted socket" + e);
                                }
                                break;
                        }
                    }
            ...
            lw.appendLog(TAG, "END mAcceptThread, socket Type: " + mSocketType);

        }

        public void cancel() {
            lw.appendLog(TAG, "Socket Type" + mSocketType + "cancel " + this);
            try {
                mmServerSocket.close();
            } catch (IOException e) {
                lw.appendLog(TAG, "Socket Type" + mSocketType + "close() of server failed" + e);
            }
        }
    }
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            lw.appendLog(TAG, "BEGIN mConnectThread SocketType:" + mSocketType);
            ...
            try {
                ...
                try {
                    ...
                    lw.appendLog(TAG, "unable to close() " + mSocketType +
        ...
        public void cancel() {
            try {
                ...
                lw.appendLog(TAG, "close() of connect " + mSocketType + " socket failed" + e);
            }
        }
    }
    ...
    private class ConnectedThread extends Thread {
        ...
        public ConnectedThread(BluetoothSocket socket, String socketType) {
            lw.appendLog(TAG, "create ConnectedThread: " + socketType);
            mmSocket = socket;
            ...
            try {
                ...
                lw.appendLog(TAG, "temp sockets not created" + e);
            }
      ...
      /* public void run() {
        ...
        public void write(byte[] buffer) {
            try {
                ...
                lw.appendLog(TAG, "Exception during write" + e);
            }
        }
        ...
        public void cancel() {
            ...
            try {
                ...
                lw.appendLog(TAG, "close() of connect socket failed" + e);
            }
        }
    }
